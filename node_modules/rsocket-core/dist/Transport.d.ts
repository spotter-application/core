...
import { CancelFrame, ErrorFrame, ExtFrame, Frame, FrameTypes, KeepAliveFrame, LeaseFrame, MetadataPushFrame, PayloadFrame, RequestChannelFrame, RequestFnfFrame, RequestNFrame, RequestResponseFrame, RequestStreamFrame, ResumeFrame, ResumeOkFrame, SetupFrame } from "./Frames";
...
export interface Stream extends Outbound {
    ...
    send(frame: CancelFrame | ErrorFrame | PayloadFrame | RequestChannelFrame | RequestFnfFrame | RequestNFrame | RequestResponseFrame | RequestStreamFrame | ExtFrame): void;
}
...
export interface StreamFrameHandler extends FrameHandler {
    readonly streamType: FrameTypes.REQUEST_CHANNEL | FrameTypes.REQUEST_FNF | FrameTypes.REQUEST_RESPONSE | FrameTypes.REQUEST_STREAM;
